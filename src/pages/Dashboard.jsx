        ...
        <div className="pb-16 flex flex-col gap-4">
          <div className="flex flex-col gap-4 px-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <button onClick={handleVMap} className="flex w-full bg-[url('/src/assets/map-btn.png')] bg-cover p-3 items-center justify-between rounded-lg shadow-gray-500 shadow-md text-white text-md font-medium">
                <p>CSU 3D Virtual Map</p>
              </button>
              <button onClick={handleTour} className="flex w-full bg-[url('/src/assets/map-btn.png')] bg-cover p-3 items-center justify-between rounded-lg shadow-gray-500 shadow-md text-white text-md font-medium">
                <p>CSU 360 Tour</p>
              </button>
              </div>
            </div>
